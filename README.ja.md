...
これが無いと提案側は公平すぎる: run W の種は confirm で「コード無し 8/72」と言っていたのに、
width 4・7 種類・5 クラスでは research の prefill が 5 世代のうちに列の先頭へ来ない。巡回は
どこも飢えさせないためにあるが、測定が場所を既に言っているのに順番待ちさせるのは、ループが
自分のデータを無視することになる。
